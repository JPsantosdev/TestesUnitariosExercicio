...
## Solução
O Código foi implementado como foi solicitado pelo professor do bootcamp. Com este exercício foi possível abstrair o funcionamento e a produção de testes unitários utilizando a ferramenta XUnit para desenvolvimento de testes em C#.